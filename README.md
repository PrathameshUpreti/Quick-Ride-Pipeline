...
## 📁 Project Structure
```
quickride-data-platform/
├── aws/
│   ├── s3_bucket_setup.sh           # S3 bucket creation
│   ├── iam_policies.json            # IAM for Snowpipe
│   └── sns_sqs_setup.sh             # Event notifications
├── snowflake/
│   ├── setup/
│   │   ├── 01_databases.sql
│   │   ├── 02_schemas.sql
│   │   ├── 03_warehouses.sql
│   │   ├── 04_roles.sql
│   │   ├── 05_stages.sql            # External S3 stage
│   │   └── 06_snowpipes.sql         # Snowpipe definitions
│   ├── clustering/
│   │   └── cluster_keys.sql
│   └── materialized_views/
│       └── analytics_views.sql
...
│   │   │   ├── stg_drivers.sql
│   │   │   ├── stg_riders.sql
│   │   │   └── schema.yml           # Source freshness
│   │   ├── intermediate/
│   │   │   └── int_ride_metrics.sql
│   │   ├── marts/
│   │   │   ├── fact_rides.sql       # Incremental
│   │   │   ├── fact_payments.sql
...
│   ├── macros/
│   │   ├── calculate_distance_category.sql
│   │   ├── calculate_surge_multiplier.sql
...
│       └── data/
│           └── expected_ride_statuses.csv
├── airflow/
│   ├── dags/
│   │   ├── quickride_daily_pipeline.py
│   │   ├── data_quality_checks.py
│   │   └── backfill_historical.py
│   └── config/
│       └── connections.yml.example
├── data_generator/
│   └── generate_ride_data.py        # Simulates ride data
├── dashboards/
│   ├── quickride_analytics.pbix
│   └── screenshots/
└── docs/
    ├── setup_guide.md
